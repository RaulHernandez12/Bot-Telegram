...
function keyBot ($chatId){
    ...
    $maximo = 5;
    $region = 'ES';
    $url_youtube = 'https://www.googleapis.com/youtube/v3/search?key=AIzaSyAvWKk9QNoGiBPj7vhFtTO6kN4ZnVppumc&channelId=UCyQqzYXQBUWgBTn4pw_fFSQ&max_results=2&region=ES';
    $url = $url_youtube;
    $url.='?key='.$keyBot;
    $url.='&channelID='.$canal;
